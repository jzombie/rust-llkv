...
//!
//! This module contains the core types for managing transactions:
//! - [`TransactionContext`]: Trait defining operations a context must support
//! - [`SessionTransaction`]: Per-transaction state machine
...
pub type TransactionSessionId = u64;
    ...
    StagingCtx: TransactionContext + 'static,
{
    ...
    /// Get the session ID.
    pub fn session_id(&self) -> TransactionSessionId {
        self.session_id
    }
...
///
/// This is the top-level coordinator that creates sessions and manages
/// the shared transaction ID allocator.
